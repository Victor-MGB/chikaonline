    ...
    <>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center p-6">
          <h3 className="text-4xl font-bold mb-4 text-white">Term and Services</h3>
          <div className="flex items-center space-x-2 text-white">
            ...
            <p className="text-sm hover:text-red-500 text-yellow-700 font-bold">Terms and Services</p>
          </div>
        </div>
      </div>
    </section>
